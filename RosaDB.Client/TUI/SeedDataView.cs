    ...
    public class SeedDataView : View
    {
        ...
        private async Task SeedData()
        {
            ...
            try
            {
                ...
                await SendQuery("CREATE MODULE users (id INT INDEX, name TEXT, age INT);");
                ...
                await SendQuery("CREATE MODULE warehouses (id INT INDEX, name TEXT, location TEXT);");
                ...
                await SendQuery("CREATE MODULE products (id INT INDEX);");
                ...
                await SendQuery("CREATE MODULE catalog (id INT INDEX, name TEXT);");
                await SendQuery("CREATE TABLE catalog.products (id INT PRIMARY KEY, name TEXT, category TEXT, price TEXT);");

                await SeedUserModuleInstances();
                await SeedUserTables();
                await SeedWarehouseModuleInstances();
                await SeedWarehouseTables();
                await SeedCatalog();
                await SeedProductModuleInstances();
        ...
        private async Task SeedCatalog()
        {
            ...
            try
            {
                await SendQuery("INSERT MODULE catalog (id, name) VALUES (1, 'main_catalog');");
        ...
        private async Task SeedProductModuleInstances()
        {
            Log("Creating product instances...");
            await SendQuery("INSERT MODULE products (id) VALUES (1);");
            await SendQuery("INSERT MODULE products (id) VALUES (2);");
            await SendQuery("INSERT MODULE products (id) VALUES (3);");
            await SendQuery("INSERT MODULE products (id) VALUES (4);");
        }
        ...
        private async Task SeedWarehouseModuleInstances()
        {
            Log("Creating warehouse instances...");
            await SendQuery("INSERT MODULE warehouses (id, name, location) VALUES (1, 'Main Warehouse', 'New York');");
            await SendQuery("INSERT MODULE warehouses (id, name, location) VALUES (2, 'West Coast Hub', 'Los Angeles');");
            await SendQuery("INSERT MODULE warehouses (id, name, location) VALUES (3, 'East Coast Depot', 'Boston');");
        }
        ...
        private async Task SeedUserModuleInstances()
        {
            Log("Creating user instances...");
            await SendQuery("INSERT MODULE users (id, name, age) VALUES (1, 'Alice Smith', 30);");
            await SendQuery("INSERT MODULE users (id, name, age) VALUES (2, 'Bob Johnson', 25);");
            await SendQuery("INSERT MODULE users (id, name, age) VALUES (3, 'Charlie Brown', 35);");
            await SendQuery("INSERT MODULE users (id, name, age) VALUES (4, 'David Williams', 40);");
            await SendQuery("INSERT MODULE users (id, name, age) VALUES (5, 'Eve Jones', 28);");
        }
